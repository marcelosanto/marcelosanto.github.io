...
object Res {
    ...
    object String {
        const val NAME = "Marcelo Santos"
        const val PROFESSION = "Kotlin Multiplaform and Go Developer"
        const val ABOUT_ME =
            "Desbravador do Universo Kotlin Multiplatform e Go! Misturando a elegância do Kotlin com a potência do Go para criar experiências incríveis. Navegando pelos códigos com paixão e explorando os horizontes da desenvolvimento de software. Seja bem-vindo ao meu mundo de código sem fronteiras!"
        const val BUTTON_TEXT = "Get in touch"
        const val ROBOTO_CONDENSED = "RobotoCondensedBold"
        const val ROBOTO_REGULAR = "RobotoRegular"
        const val MY_EMAIL = "mailto:rocha.mer21@gmail.com"
